...
namespace SDDH.Utility.Http
{
    public class HttpClientHelper
    {
        ...
        /// <param name="url"></param>
        /// <returns></returns>
        public async static Task<T> GetResponseAsync<T>(string url)
           where T : class, new()
        {
            if (url.StartsWith("https"))
                System.Net.ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls;
        ...
        /// <param name="postData">post数据</param>
        /// <returns></returns>
        public async static Task<string> PostResponseAsync(string url, string postData)
        {
            if (url.StartsWith("https"))
                System.Net.ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls;
        ...
        /// <param name="postData">post数据</param>
        /// <returns></returns>
        public async static Task<T> PostResponseAsync<T>(string url, string postData)
            where T : class, new()
        {
            if (url.StartsWith("https"))
                System.Net.ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls;
